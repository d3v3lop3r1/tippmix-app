...
class PredictThursdayEvents extends Component {
    constructor(props) {
        super(props);
        this.state = {
            Datas:{},
    ...
    getMondayData = async ()=>{
        const GETMONDAYDATA_URL = "https://tippmix-backend.herokuapp.com/api/getthursdaypredictions";
        const options = {
            method: 'GET',
...
export default PredictThursdayEvents;
